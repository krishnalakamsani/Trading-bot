                ...
                for key, value in rows:
                    if key in config:
                        ...
                        if key in ['order_qty', 'max_trades_per_day', 'candle_interval', 'supertrend_period', 'min_trade_gap', 
                                    'rsi_period', 'macd_fast', 'macd_slow', 'macd_signal', 'ma_fast_period', 'ma_slow_period',
                                    'bollinger_period', 'stochastic_k_period', 'stochastic_d_period', 'adx_period']:
                            config[key] = int(value)
                        # Float fields
                        elif key in ['daily_max_loss', 'initial_stoploss', 'max_loss_per_trade', 'trail_start_profit', 'trail_step', 'target_points', 'risk_per_trade', 'bollinger_std', 'supertrend_multiplier']:
